...
/** GitHub source for the Issues destination: open GitHub issues assigned to you,
 *  aggregated across every git root (per-repo soft-fail), grouped by repo. The
 *  shared source switch lives in the parent, so this renders only the count. */
