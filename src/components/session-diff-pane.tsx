...
function FilesView({
  ...
  const items = useMemo(() => {
    ...
    for (let i = 0; i < textFiles.length; i++) {
      ...
      // what makes CodeView re-render the item in its new state (a reference app
      // does exactly this).
...
/** Map pierre's tree theming onto warden's tokens (a reference app's pattern). */
const TREE_STYLE = {
 ...
 *  on the right — a reference app's explorer, themed to warden. */
