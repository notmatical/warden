...
Browser-global viewport: a single open-tab strip spanning every workspace, and a recursive split-tree pane layout — drag a tab or sidebar session onto a pane edge to split it (center to swap), and drag to reorder the strip.
